...
export const asyncRouterMap = [

  {
    ...
    children: [
      ...
      //   redirect: '/dashboard/content',
      //   component: PageView,
      //   meta: { title: '内容展示', keepAlive: true, icon: "read", permission: [ 'dashboard' ] },
      //   children: [
      //     // {
      ...
      //       meta: { title: '内容展示', keepAlive: true, permission: [ 'dashboard' ] }
      //     },
      //     // 外部链接
      //     // {
      ...
      // forms
      {
        ...
        //     name: 'BaseForm',
        //     component: () => import('@/views/form/BasicForm'),
        //     meta: { title: '设置路径', keepAlive: true, permission: [ 'form' ] }
        //   },
        //   // {
        //   //   path: '/form/step-form',
        //   //   name: 'StepForm',
