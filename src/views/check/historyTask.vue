            ...
            <a-row :gutter="16">
              <a-col :span="24">
                <a-card :bordered="false">
                  ...
                  <a-row style="margin-bottom:1%" v-if="this.data.sysTask.status==1">
...
import { getmyTask, getTaskDetail, check, getTasking, getHistoryTask1 } from '@/api/plan'
...
export default {
  ...
  methods: {
    ...
    init() {
      this.taskId = this.$route.query.piId
      // console.log(this.taskId)
      const query = {
        piId: this.taskId
      }
      getHistoryTask1(query).then(res => {
        // debugger;
